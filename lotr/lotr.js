...
const greetingsName = "Master Hobbit"
...
const selectionOptionDescription = {
    ...
    narrative: `An order I think offers good narrative structure for viewers (including those watching for the first time). The emphasis is not on chronological events but rather on presenting an order which ties new entries to ones which the viewer has already seen in exciting ways.`,
